...
class Vpc(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str, *, prefix=None):
        ...
        self.vpc.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_igw.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_igw_attachment.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_public_route_table.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_public_default_route.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_public_subnet1.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_public_subnet1_route_table_association.cfn_options.condition=vpc_not_given_condition
        self.vpc_public_subnet1_eip = aws_ec2.CfnEIP(
            self,
            "VpcPublicSubnet1EIP",
            domain="vpc"
        )
        self.vpc_public_subnet1_eip.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_public_subnet1_nat_gateway.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_public_subnet2.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_public_subnet2_route_table_association.cfn_options.condition=vpc_not_given_condition
        self.vpc_public_subnet2_eip = aws_ec2.CfnEIP(
            self,
            "VpcPublicSubnet2EIP",
            domain="vpc"
        )
        self.vpc_public_subnet2_eip.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_public_subnet2_nat_gateway.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_private_subnet1.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_private_subnet1_route_table.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_private_subnet1_route_table_association.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_private_subnet1_default_route.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_private_subnet2.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_private_subnet2_route_table.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_private_subnet2_route_table_association.cfn_options.condition=vpc_not_given_condition
        ...
        self.vpc_private_subnet2_default_route.cfn_options.condition=vpc_not_given_condition
